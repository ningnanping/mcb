...
public class RedisAdapter implements RedisCache
{
    ...
    /*
     * (non-Javadoc)
     * @see com.jd.as.common.cache.BaseCache#put(java.lang.String, java.io.Serializable)
     */
    public boolean put(final String key, final Serializable value)
    {
        String statusCode = (String) redisTemplate.execute(new RedisCallback<Serializable>()
        {
    ...
    {
        Long statusCode = (Long) redisTemplate.execute(new RedisCallback<Serializable>()
        {
    ...
    /*
     * (non-Javadoc)
     * @see com.jd.as.common.cache.redis.RedisCache#putNx(java.lang.String, java.io.Serializable)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.jd.as.common.cache.BaseCache#put(java.lang.String, java.io.Serializable, int)
     */
    public boolean put(final String key, final Serializable value, final int expirationTime)
    {
        String statusCode = (String) redisTemplate.execute(new RedisCallback<Serializable>()
        {
    ...
    /*
     * (non-Javadoc)
     * @see com.jd.as.common.cache.redis.RedisCache#putMap(java.lang.String, java.util.Map)
     */
    ...
    {
        Long statusCode = (Long) redisTemplate.execute(new RedisCallback<Long>()
        {
            
            /*
             * (non-Javadoc)
             * @see com.jd.as.common.cache.redis.core.RedisCallback#doInRedis(redis.clients.jedis.ShardedJedis)
             */
    ...
    public List<Object> putMap(final Map<String, Serializable> map, final int expTime)
    {
        ...
        String statusCode = redisTemplate.execute(new RedisCallback<String>()
        {
            ...
            public String doInRedis(ShardedJedis jedis)
            {
                try
                {
                    ...
                    return jedis.getShard(map.keySet().toArray(new String[] {})[0]).mset(
        ...
        {
            throw new RuntimeException("The batch add value fails:[statusCode:" + statusCode + ", map:" + map + "]");
        }
    ...
    /*
     * (non-Javadoc)
     * @see com.jd.as.common.cache.redis.RedisCache#publish(java.lang.String, java.lang.String)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.jd.as.common.cache.redis.RedisCache#subscribe(redis.clients.jedis.JedisPubSub, java.lang.String)
     */
    ...
    public <V extends Serializable> V getSet(final String key, final String score)
    {
        return redisTemplate.execute(new RedisCallback<V>()
        {
            ...
            public V doInRedis(ShardedJedis jedis)
            {
                try
                {
                    Set<byte[]> bytes = jedis.zrangeByScore(key.getBytes(), Double.parseDouble(score),
